...
Future<void> copyToClipboard(
  ...
  if (isSensitive) {
    _startSensitiveClipboardTimer();
  }
}

/// Starts or restarts the sensitive clipboard clearing timer
...
void checkAndClearExpiredClipboard() {
  if (_clipboardSetTime != null &&
      DateTime.now().difference(_clipboardSetTime!).inSeconds >= 60) {
    _clearSensitiveClipboard();
    appLogger.i('[Clipboard] cleared expired sensitive content on app resume');
  }
}
