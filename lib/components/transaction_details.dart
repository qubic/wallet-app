...
class _TransactionDetailsState extends State<TransactionDetails> {
  ...
  Widget _buildStatusLabel(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(statusText, style: textStyle.copyWith(color: statusColor)),
    );
  }
                      ...
                      if (isQxTransferShares) ...[
                        DecoratedBox(
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(
                                color: LightThemeColors.primary40, width: 0.8),
                          ),
                          ...
                          child: FittedBox(
                            child: Text.rich(
                              TextSpan(children: [
                                ...
                                TextSpan(
                                    text:
                                        "  ${isQxTransferShares ? widget.assetTransfer!.assetName : l10n.generalLabelCurrencyQubic}",
                                    style: const TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w500,
                                      letterSpacing: -0.48,
                                      color:
                                          LightThemeColors.secondaryTypography,
                                    )),
                              ]),
                              textAlign: TextAlign.center,
                            ),
                        ...
                        child: Column(
                          ...
                          Observer(
                              builder: (context) => getCopyableDetails(
                                  ...
                                  TransactionUIHelpers.getTransactionTypeLong(
                                      widget.item.type ?? 0,
                                      widget.item.destId))),
                          ThemedControls.spacerVerticalSmall(),
                          ...
                          getFromTo(
                              ...
                              isQxTransferShares
                                  ...
                                  : widget.item.destId),
                          ThemedControls.spacerVerticalSmall(),
                          getCopyableDetails(context, l10n.generalLabelTick,
